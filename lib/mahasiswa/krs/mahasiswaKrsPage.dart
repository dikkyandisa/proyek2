...
class MahasiswaKrs extends StatefulWidget {
  const MahasiswaKrs({Key? key}) : super(key: key);

  @override
  MahasiswaKrsPage createState() => MahasiswaKrsPage();
}

class MahasiswaKrsPage extends State<MahasiswaKrs> {
  @override

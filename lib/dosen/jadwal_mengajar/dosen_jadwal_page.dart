...
class DosenJadwal extends StatefulWidget {
  const DosenJadwal({Key? key}) : super(key: key);

  @override
  DosenJadwalPage createState() => DosenJadwalPage();
}

class DosenJadwalPage extends State<DosenJadwal> {
  @override

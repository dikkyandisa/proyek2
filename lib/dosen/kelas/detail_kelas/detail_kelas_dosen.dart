...
class DosenDetailKelas extends StatefulWidget {
  const DosenDetailKelas({Key? key}) : super(key: key);

  @override
  DosenDetailKelassPage createState() => DosenDetailKelassPage();
}

class DosenDetailKelassPage extends State<DosenDetailKelas> {
  @override
